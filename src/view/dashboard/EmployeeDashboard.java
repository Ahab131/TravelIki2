...
public class EmployeeDashboard extends JFrame {
    private static EmployeeDashboard frame;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            EmployeeDashboard eDashboard = new EmployeeDashboard(authService.getPengguna());
            eDashboard.setVisible(true);
        });
    }
    
    public EmployeeDashboard(Pengguna activeUser) {
    ...
    private void initializeComponents(Pengguna activeUser) {
        ...
        // ### FRAME UTAMA
        frame = this;
        frame.setTitle("Traveliki - Employee Dashboard");
