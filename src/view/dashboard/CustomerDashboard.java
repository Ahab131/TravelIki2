...
public class CustomerDashboard extends JFrame {
    private static CustomerDashboard frame;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            CustomerDashboard cDashboard = new CustomerDashboard(authService.getPengguna());
            cDashboard.setVisible(true);
        });
    }
    
    public CustomerDashboard(Pengguna activeUser) {
    ...
    private void initializeComponents(Pengguna activeUser) {
        ...
        // ### FRAME UTAMA
        frame = this;
        frame.setTitle("Traveliki - Customer Dashboard");
